...
var file_internal_infra_grpc_proto_order_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x07, 0x0a, 0x05, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x22, 0x60, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x2b, 0x0a, 0x06, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73,
	...
	,
...
var file_internal_infra_grpc_proto_order_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_internal_infra_grpc_proto_order_proto_goTypes = []interface{}{
	(*Empty)(nil),            // 0: pb.Empty
	(*Order)(nil),            // 1: pb.Order
	(*Orders)(nil),           // 2: pb.Orders
	(*CreateOrderInput)(nil), // 3: pb.CreateOrderInput
}
var file_internal_infra_grpc_proto_order_proto_depIdxs = []int32{
	1, // 0: pb.Orders.orders:type_name -> pb.Order
	3, // 1: pb.OrderService.CreateOrder:input_type -> pb.CreateOrderInput
	0, // 2: pb.OrderService.ListOrders:input_type -> pb.Empty
...
func file_internal_infra_grpc_proto_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_infra_grpc_proto_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_infra_grpc_proto_order_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_infra_grpc_proto_order_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Orders); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_infra_grpc_proto_order_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
